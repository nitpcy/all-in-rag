...
documents = TextLoader("../../data/C4/txt/ai.txt", encoding="utf-8").load()
...
retriever = FAISS.from_documents(texts, hf_bge_embeddings).as_retriever()
...
docs = final_retriever.invoke("AI还有哪些缺陷需要克服？")
